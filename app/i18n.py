...
_METINLER: dict[str, dict[Dil, str]] = {
    ...
    "nav_onay": {"tr": "Onay Kuyrugu", "en": "Approval Queue"},
    ...
    "onaya_gonder": {"tr": "Onaya Gonder", "en": "Submit for Approval"},
    "onay_hedefi": {"tr": "Onaylayacak yonetici", "en": "Approver"},
    "onay_hedefi_sec": {"tr": "Seciniz", "en": "Select"},
    "onay_hedefi_gerekli": {
        "tr": "Onaya gondermek icin listeden bir yonetici secin.",
        "en": "Select an approver from the list before submitting.",
    },
    "onay_zincir_yok": {
        "tr": "Yonetici zinciriniz bulunamadi; su an yalnizca taslak kaydedebilirsiniz. Cikis yapip tekrar giris deneyin.",
        "en": "Your manager chain was not found; you can only save drafts for now. Sign out and sign in again.",
    },
    "indirim_yuzdesi": {"tr": "Indirim %", "en": "Discount %"},
    "durum": {"tr": "Durum", "en": "Status"},
    "durum_taslak": {"tr": "Taslak", "en": "Draft"},
    "durum_onay_bekliyor": {"tr": "Onay bekliyor", "en": "Pending approval"},
    "durum_onaylandi": {"tr": "Onaylandi", "en": "Approved"},
    "durum_reddedildi": {"tr": "Reddedildi", "en": "Rejected"},
    "durum_iptal_edildi": {"tr": "Iptal edildi", "en": "Cancelled"},
    "duzenle": {"tr": "Duzenle", "en": "Edit"},
    "duzenle_tekrar_gonder": {"tr": "Duzenle ve tekrar gonder", "en": "Edit and resubmit"},
    "gecmis_taslaklar": {"tr": "Taslaklar", "en": "Drafts"},
    "gecmis_gonderilenler": {"tr": "Gonderilenler", "en": "Submitted"},
    "gecmis_taslak_bos": {"tr": "Henuz taslak yok.", "en": "No drafts yet."},
    "gecmis_gonderilen_bos": {"tr": "Henuz onaya gonderilmis kayit yok.", "en": "No submitted estimates yet."},
    "gecmis_tum_durumlar": {"tr": "Tum durumlar", "en": "All statuses"},
    "onayla": {"tr": "Onayla", "en": "Approve"},
    "reddet": {"tr": "Reddet", "en": "Reject"},
    "gerekce": {"tr": "Gerekce (opsiyonel)", "en": "Reason (optional)"},
    "iptal_et": {"tr": "Iptal et", "en": "Cancel estimate"},
    "red_gerekce": {"tr": "Red gerekcesi", "en": "Rejection reason"},
    "onay_baslik": {"tr": "Onay Kuyrugu", "en": "Approval Queue"},
    "onay_aciklama": {
        "tr": "Size yoneltilen onay bekleyen hesaplamalar.",
        "en": "Estimates waiting for your approval.",
    },
    "onay_bos": {"tr": "Bekleyen onay yok.", "en": "No pending approvals."},
    "aktivite_baslik": {"tr": "Aktivite Gunlugu", "en": "Activity Log"},
    "aktivite_aciklama": {
        "tr": "Onay, red ve iptal islemlerinin kaydi.",
        "en": "Log of approve, reject, and cancel actions.",
    },
    "aktivite_bos": {"tr": "Henuz kayit yok.", "en": "No activity yet."},
    "aktor": {"tr": "Aktor", "en": "Actor"},
    "islem": {"tr": "Islem", "en": "Action"},
    "rapor_baslik": {"tr": "Raporlar", "en": "Reports"},
    "rapor_aciklama": {
        "tr": "Yalnizca onaylanmis kayitlar (USD).",
        "en": "Approved estimates only (USD).",
    },
    "rapor_bos": {"tr": "Filtreye uyan onaylanmis kayit yok.", "en": "No matching approved estimates."},
    "birim": {"tr": "Birim", "en": "Unit"},
    "onaylayan": {"tr": "Onaylayan", "en": "Approver"},

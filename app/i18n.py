...
_METINLER: dict[str, dict[Dil, str]] = {
    ...
    "nav_birim_kayitlari": {"tr": "Birim Kayıtları", "en": "Department Records"},
    "bs_etiket": {"tr": "Birim Yönetimi", "en": "Department Management"},
    "bs_baslik": {"tr": "Birim Yönetim Özeti", "en": "Department Management Overview"},
    "bs_aciklama": {
    ...
    "bs_son_kayitlar": {"tr": "Son Birim Kayıtları", "en": "Recent Department Records"},
    ...
    "gm_alt_birim_filtre": {"tr": "Alt departman", "en": "Sub-department"},
    "gm_tum_alt_birimler": {"tr": "Tüm alt departmanlar", "en": "All sub-departments"},
    "gm_tarih_hatasi": {
    ...
    "indirimli_aylik_maliyet": {
        "tr": "İndirimli aylık maliyet",
        "en": "Discounted monthly cost",
    },
    "indirimli_yillik_maliyet": {
        "tr": "İndirimli yıllık maliyeti",
        "en": "Discounted annual cost",
    },
    ...
    "reddeden": {"tr": "Reddeden", "en": "Rejected by"},
    ...
    "birim": {"tr": "Departman", "en": "Department"},
    ...
    "alan_sure_birimi": {"tr": "Süre birimi", "en": "Duration"},
    ...
    "xlsx_birim": {"tr": "Ölçü", "en": "Measure"},
    "xlsx_birim_fiyat": {"tr": "Birim Fiyat", "en": "Price"},
